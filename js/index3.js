window.onload = function () {
    ...
    // document.getElementsByClassName("elec_up").addEventListener('touchend', function (event) {
    //     // 清除默认行为
    ...
    // let elec_up_coverWidth = $(".elec_up").width();
    // let elec_up_coverheight = $(".elec_up").height();
    // alert($(".elec_up").css("paddingLeft"));
    // alert($(".elec_up").css("paddingLeft"));
    // alert(parseFloat($(".elec_up").height()) + parseFloat($(".elec_up").css("paddingTop")) + parseFloat($(".elec_up").css("paddingBottom")) + 'px');
    ...
    touch.on('#elec_body', 'touchend', '.elec_down_cover', function (ev) {
        $(this).parents(".elec_down").css("background-color", "#5b9bd5");
        elecColorDown = false;
    });
